...
<template>
    <div v-if="store.dropDown" class="bg-gray-700 bg-opacity-60 z-30 fixed inset-0 flex items-start justify-center">
        <div class="w-[340px] bg-gray-100 rounded-md z-30 mt-40 sm:w-[560px] overflow-hidden">
           <div class="p-3">
                <div class="relative">
                    <input type="text" placeholder="Search docs" class="w-full py-3 pl-10 border-2 border-violet-900 rounded-md">
                    <svg width="24" height="24" class="absolute top-1/2 -translate-y-1/2 left-2" viewBox="0 0 20 20"><path d="M14.386 14.386l4.0877 4.0877-4.0877-4.0877c-2.9418 2.9419-7.7115 2.9419-10.6533 0-2.9419-2.9418-2.9419-7.7115 0-10.6533 2.9418-2.9419 7.7115-2.9419 10.6533 0 2.9419 2.9418 2.9419 7.7115 0 10.6533z" stroke="currentColor" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                </div>
                <div class="py-10">
                    <p class="text-xs text-center text-gray-500">No recent searches</p>
                </div>
           </div>

            <div class="flex items-center justify-between bg-white shadow-md p-3">
                <div class="flex items-center gap-3">
                   <div class="flex items-center gap-1">
                        <kbd class="h-5 w-5 shadow-md rounded-sm bg-white group-hover:bg-gray-100 text-xs flex items-center justify-center">
                            <svg width="15" height="15" aria-label="Enter key" role="img"><g fill="none" stroke="gray" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.2"><path d="M12 3.53088v3c0 1-1 2-2 2H4M7 11.53088l-3-3 3-3"></path></g></svg>
                        </kbd>
